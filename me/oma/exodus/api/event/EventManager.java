package me.oma.exodus.api.event;
...
public class EventManager {
    ...
    private static void register(final Method method, final Object o) {
        ...
        final Data methodData = new Data(o, method, method.getAnnotation(ClientEvent.class).value());
    ...
    private static boolean isMethodBad(final Method method) {
        ...
        return method.getParameterTypes().length != 1 || !method.isAnnotationPresent(ClientEvent.class);
    }
